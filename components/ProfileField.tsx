...
const BioRow: React.FC<BioRowProps> = ({ label, value, leftSubtext, rightSubtext }) => {
    return (
...
const ProfileField: React.FC = () => {
  return (
    ...
    <BioRow label="About me" value="" leftSubtext='I love cats and baking muffins. I would love a roommate to join me! Please do not eat my cats, but please do eat my muffins!' />
